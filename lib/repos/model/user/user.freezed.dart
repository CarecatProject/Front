...
abstract class $UserCopyWith<$Res> {
  ...
  $Res call(
      {int id, String name, String nickname, String image, int contribution});
}
...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, nickname: $nickname, image: $image, contribution: $contribution)';
  }
...
abstract class _User implements User {
  factory _User(
      ...
      required String nickname,
      required String image,
      required int contribution}) = _$_User;
